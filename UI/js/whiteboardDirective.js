angular.module('Whiteboard').directive('whiteboard', ['Socket',
            ...
            link: function($scope, iElm, iAttrs, controller) {
                ...
                tool.onMouseUp = function(event) {
                    if ($scope.textTool) {
                        ...
                        console.log(event.point);
                        $("body").append("<textarea class='tempareas' style='position:absolute; top:" + (start.y + 50) + "px; left:" + start.x + "px; width: " + (end.x - start.x) + "px; height:" + (end.y - start.y) + "px;'></textarea>")
                        $(".tempareas").focus();
                    }
